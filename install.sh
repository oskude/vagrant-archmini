...
cat <<-'EOF' > /etc/pacman.conf
	...
	NoExtract = !usr/lib/modules/*/kernel/drivers/acpi/processor.ko.gz
	...
	NoExtract = !usr/lib/modules/*/kernel/drivers/ata/ahci.ko.gz
	NoExtract = !usr/lib/modules/*/kernel/drivers/ata/libahci.ko.gz
